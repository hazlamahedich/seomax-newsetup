 ...
 */
function extractMetadata(document: Document): ScrapedContent['metadata'] {
 ...
 */
function extractHeadings(document: Document): ScrapedContent['headings'] {
  const headings = {
 ...
 */
function extractImages(document: Document): ScrapedContent['images'] {
